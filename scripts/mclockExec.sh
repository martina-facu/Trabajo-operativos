...
cp $CONFPATH/memoria.config.mclock $MEMORYPATH/memoria.config
cp $CONFPATH/cpu.config.mclock $CPUPATH/cpu.config
cp $CONFPATH/kernel.config.mclock $KERNELPATH/kernel.config
cp $CONFPATH/consola.config.mclock $CONSOLEPATH/consola.config
