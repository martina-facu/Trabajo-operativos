...
cp $CONFPATH/memoria.config.ksuspsrt $MEMORYPATH/memoria.config
cp $CONFPATH/cpu.config.ksuspsrt $CPUPATH/cpu.config
cp $CONFPATH/kernel.config.ksuspsrt $KERNELPATH/kernel.config
cp $CONFPATH/consola.config.ksuspsrt $CONSOLEPATH/consola.config
